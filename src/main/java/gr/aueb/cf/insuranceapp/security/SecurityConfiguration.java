    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(req -> req
                        ...
                        .requestMatchers("/api/customers/filtered").permitAll()
                        .requestMatchers("/api/customers/filtered/paginated").permitAll()
                        .requestMatchers("/api/customers/afm/{afm}").permitAll()
                        .requestMatchers("/api/customers/{id}").permitAll()
                        .requestMatchers("/api/customers/dropdown").permitAll()
                        .requestMatchers("/api/auth/authenticate").permitAll()
                        .requestMatchers("/api/policies/create").permitAll()
                        .requestMatchers("/api/policies/paginated").permitAll()
